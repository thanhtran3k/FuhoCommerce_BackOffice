...
namespace FuhoCommerce.IdentityServer.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterRequestViewModel model)
        {
            ...
            return Redirect(frontOfficeUrl);
        }
        ...
        {
            var validUrl = _interaction.IsValidReturnUrl(returnUrl);
        ...
        private async Task AddClaimToUser(AppUser user, string role)
        {
